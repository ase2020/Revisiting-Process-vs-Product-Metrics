...
if __name__ == "__main__":
    ...
    for _metric in metric_type:
        ...
        for project in projects[150:]:
            try:
                if project == '.DS_Store':
                    continue
                print("+++++++++++++++++   "  + project + "  +++++++++++++++++")
                recall,precision,pf,f1,g_score,auc,pci_20,ifa,importance = run_self_k(project,_metric)
        ...
        with open('results/Performance/commit_guru_file_specific/' + _metric + '_700_svm_cross.pkl', 'wb') as handle:
